...
REGISTRY_PROVISION_SA_ID = os.getenv("DEV_PROVISION_SA_ID")
REGISTRY_PROVISION_SA_SECRET = os.getenv("DEV_PROVISION_SA_SECRET")
...
with DAG(
    dag_id="accountability_jobs_dev",
    description="Public Cloud accountability scheduled jobs (dev)",
    schedule="0 6 * * *",
