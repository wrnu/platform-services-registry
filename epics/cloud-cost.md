...
| Notification routing                 | **Implemented**             | Configurable on cost-rules admin UI; Keycloak fallback — see [rules config — notification routing](./cloud-cost-rules-config.md#notification-routing) |
